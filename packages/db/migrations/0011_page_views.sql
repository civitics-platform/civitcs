...
CREATE INDEX idx_page_views_entity     ON page_views(entity_type, entity_id) WHERE entity_id IS NOT NULL;
CREATE INDEX idx_page_views_bot        ON page_views(is_bot, viewed_at);
