...
CREATE INDEX financial_entities_name ON financial_entities(name);
CREATE INDEX financial_entities_entity_type ON financial_entities(entity_type);
CREATE INDEX financial_entities_total_donated ON financial_entities(total_donated_cents DESC);
CREATE INDEX financial_entities_updated_at ON financial_entities(updated_at);
